...
export interface GeneratedExportedFunctions {
	...
	get_string_by_name_from_script_info: (p_0: I32, p_1: I32) => Annotated<PtrWrapper<I32>, Annotations<Malloced<"free">, IsCString, NoAnnot<"free_fn">, IsNullable>>
	...
	get_file_type_from_file_props: (p_0: I32) => EnumWrapper<"FileType", UInt8T>
	get_line_type_from_file_props: (p_0: I32) => EnumWrapper<"LineType", UInt8T>
	...
	get_entry_from_name_in_extra_section_entry: (p_0: I32, p_1: I32) => Annotated<PtrWrapper<I32>, Annotations<NoAnnot<"malloced">, IsCString, NoAnnot<"free_fn">, IsNullable>>
