...
[[nodiscard]] bool str_view_get_substring_by_delimiter(StrView* str_view,
                                                       ConstStrView* result,
...
[[nodiscard]] bool str_view_get_substring_until_eof(StrView* str_view,
                                                    ConstStrView* result);

[[nodiscard]] bool str_view_skip_while(StrView* str_view, DelimiterFn delimit_fn,
                                       void* data_ptr);
